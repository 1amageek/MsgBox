Pod::Spec.new do |s|
  ...
  s.name         = "MessageBox"
  s.version      = "0.0.3"
  s.summary      = "MessageBox can build Chat by linking Firestore and Realm."
  s.description  = <<-DESC
Since Firestore takes time even when reading from the local, we decided to use Realm locally.
                   DESC

  s.homepage     = "https://github.com/1amageek/MessageBox"
  ...
  s.source       = { :git => "https://github.com/1amageek/MessageBox.git", :tag => "#{s.version}" }
