...
//        }()
        ...
        public lazy var balloonTopConstraint: NSLayoutConstraint = {
            return self.stackView.topAnchor.constraint(equalTo: nameView.bottomAnchor, constant: self.contentInset.top)
        }()
        ...
        public let nameView: NameView = NameView.instantiate()
        ...
        public override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
            ...
            self.nameView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: self.contentInset.top).isActive = true
            self.nameView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: self.contentInset.left).isActive = true
            self.contentView.trailingAnchor.constraint(equalTo: nameView.trailingAnchor, constant: self.contentInset.right).isActive = true
            ...
            self.stackView.addArrangedSubview(pictureView)
